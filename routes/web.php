...
Route::middleware(['validate.login'])->group(function () {
    ...
    Route::prefix('settings')->group(function () {
        ...
        Route::prefix('user')->group(function () {
            ...
            Route::post('data', [SettingsUser::class, 'data'])->name('settings.user.data')/* ->middleware('permission:user_lihat') */;
    ...
    Route::prefix('karyawan')->group(function () {
        ...
        Route::prefix('add')->group(function () {
            Route::get('index', [KaryawanAdd::class, 'index'])->name('karyawan.add.index')->middleware('permission:tambah karyawan');
