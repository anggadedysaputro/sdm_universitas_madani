...
@endsection
@section('breadcrumb')
    <x-bread-crumbs breadcrumbtitle="settings.masters.negara.index"/>
@endsection
@section('page-title')
    Negara
@endsection
...
<a id="tambah" class="btn btn-primary" role="button">
	<i class="ti ti-plus"></i> Tambah negara
</a>
@endsection
@section('search')
...
<div class="card p-3">
    <div class="card-table table-responsive">
        <table class="table table-vcenter" id="table-main">
            <thead>
            <tr>
                <th class="col-md-1 text-center">Kode negara</th>
...
<div class="offcanvas offcanvas-end" tabindex="-1" aria-labelledby="offcanvasEndLabel" id="canvas-main">
    <div class="offcanvas-header">
		<h2 class="offcanvas-title" id="offcanvasEndLabel">Input negara</h2>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="keterangan" placeholder="Input nama negara" fdprocessedid="tigmx5" required>
                        <div class="invalid-feedback">Nama negara belum diisi</div>
                    </div>
                </div>
            </div>
        </form>
        ...
        class Helper {
            ...
            static hapus(e){
                ...
                Swal.fire({
                    ...
                    if(result.isConfirmed){
                        $.ajax({
                            url : "{{ route('settings.masters.negara.delete') }}",
                            method : "DELETE",
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                            },
        ...
        export default class Index extends Helper{
            ...
            constructor() {
                ...
                Index.DT_Main=$("#table-main").DataTable({
                    ajax : {
                        url : "{{ route('settings.masters.negara.data') }}",
                        method : "POST",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
