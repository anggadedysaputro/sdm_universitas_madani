...
@endsection
@section('breadcrumb')
    <x-bread-crumbs breadcrumbtitle="settings.masters.biaya.index"/>
@endsection
@section('page-title')
    Biaya
@endsection
...
<div class="card p-3">
    <div class="card-table table-responsive">
        <table class="table table-vcenter" id="table-main">
            <thead>
            <tr>
                <th class="col-md-1 text-center">Kode biaya</th>
...
<div class="offcanvas offcanvas-end" tabindex="-1" aria-labelledby="offcanvasEndLabel" id="canvas-main">
    <div class="offcanvas-header">
		<h2 class="offcanvas-title" id="offcanvasEndLabel">Input biaya</h2>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="urai" placeholder="Input nama biaya" fdprocessedid="tigmx5" required>
                        <div class="invalid-feedback">Nama biaya belum diisi</div>
                    </div>
                </div>
            </div>
        </form>
    ...
    <script type="module">
        ...
        class Helper {
            ...
            simpan(){
                ...
                let url = (mode == 'edit' ? '{{ route('settings.masters.biaya.edit') }}' : '{{ route('settings.masters.biaya.store') }}');
            ...
            static hapus(e){
                ...
                Swal.fire({
                    ...
                    if(result.isConfirmed){
                        $.ajax({
                            url : "{{ route('settings.masters.biaya.delete') }}",
                            method : "DELETE",
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                            },
        ...
        export default class Index extends Helper{
            ...
            constructor() {
                ...
                Index.DT_Main=$("#table-main").DataTable({
                    ajax : {
                        url : "{{ route('settings.masters.biaya.data') }}",
                        method : "POST",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
