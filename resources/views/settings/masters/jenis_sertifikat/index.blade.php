...
@endsection
@section('breadcrumb')
    <x-bread-crumbs breadcrumbtitle="settings.masters.jenis-sertifikat.index"/>
@endsection
@section('page-title')
    Jenis Sertifikat
@endsection
...
<a id="tambah" class="btn btn-primary" role="button">
	<i class="ti ti-plus"></i> Tambah jenis sertifikat
</a>
@endsection
@section('search')
...
<div class="card p-3">
    <div class="card-table table-responsive">
        <table class="table table-vcenter" id="table-main">
            <thead>
            <tr>
                <th class="col-md-1 text-center">Kode jenis sertifikat</th>
...
<div class="offcanvas offcanvas-end" tabindex="-1" aria-labelledby="offcanvasEndLabel" id="canvas-main">
    <div class="offcanvas-header">
		<h2 class="offcanvas-title" id="offcanvasEndLabel">Input jenis sertifikat</h2>
    ...
    <div class="offcanvas-body">
        <form action="#" id="form-main">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="mb-3">
                        <label class="form-label">Nama jenis sertifikat</label>
                        <input type="text" class="form-control" name="urai" placeholder="Input nama jenis sertifikat" fdprocessedid="tigmx5" required>
                        <div class="invalid-feedback">Nama jenis sertifikat belum diisi</div>
                    </div>
                </div>
            </div>
        </form>
...
@section('jsweb')
    <script type="module">
        ...
        class Helper {
            ...
            tambah(){
                Index.FRM_Main.find('input[name="urai"]').val("");
            ...
            simpan(){
                ...
                let url = (mode == 'edit' ? '{{ route('settings.masters.jenis-sertifikat.edit') }}' : '{{ route('settings.masters.jenis-sertifikat.store') }}');
            ...
            static hapus(e){
                ...
                Swal.fire({
                    ...
                    if(result.isConfirmed){
                        $.ajax({
                            url : "{{ route('settings.masters.jenis-sertifikat.delete') }}",
                            method : "DELETE",
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                            },
            ...
            static edit(e){
                ...
                Index.FRM_Main.find('input[name="urai"]').val(data.urai);
        ...
        export default class Index extends Helper{
            ...
            constructor() {
                ...
                Index.DT_Main=$("#table-main").DataTable({
                    ajax : {
                        url : "{{ route('settings.masters.jenis-sertifikat.data') }}",
                        method : "POST",
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
