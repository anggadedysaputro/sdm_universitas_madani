...
namespace App\Http\Controllers\Select2\JenisSertifikat;

use App\Http\Controllers\Controller;
use App\Models\Masters\JenisSertifikat;
use Illuminate\Support\Facades\DB;

class Select2JenisSertifikat extends Controller
{
    public function data()
    {
        ...
        $query = JenisSertifikat::select("id", "urai as text", DB::raw("sum(1)over() as total"))
